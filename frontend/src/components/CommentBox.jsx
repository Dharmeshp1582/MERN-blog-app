...
const CommentBox = ({ selectedBlog }) => {
    ...
    const commentHandler = async () => {
        const isReply = activeReplyId !== null
        const commentContent = isReply ? replyText : content
        ...
        try {
            const res = await axios.post(
                ...
                isReply ? { content: replyText, parentId: activeReplyId } : { content },
                {
            ...
            if (res.data.success) {
                ...
                // Reset input fields
                isReply ? setReplyText('') : setContent('')
